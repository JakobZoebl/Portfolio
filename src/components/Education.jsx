...
const EducationCard = ({ delayClass, icon, bgClass, textClass, badgeText, title, subtitle, description }) => (
  <div className={`reveal ${delayClass} glass-panel rounded-2xl p-8 hover:bg-white dark:hover:bg-slate-800/30 transition-all group relative overflow-hidden`}>
...
const Education = () => {
  return (
    <section id="education" className="py-24 px-6 bg-slate-50 dark:bg-[#0a0a0a] transition-colors">
