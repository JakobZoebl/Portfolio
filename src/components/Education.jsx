...
const EducationCard = ({ delayClass, icon, bgClass, textClass, badgeText, title, subtitle, description }) => (
  <div className={`reveal ${delayClass} rounded-2xl p-8 bg-white/5 hover:bg-white/10 transition-all group relative overflow-hidden border border-white/10`}>
...
const Education = () => {
  return (
    <section id="education" className="parallax-slide py-24 px-6 bg-[#2C2B2B] transition-colors">
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-16 reveal">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-display text-white">Education</h2>
